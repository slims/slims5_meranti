...
$custom_fields['series_title'] = array(1, __('Series Title')); // enable volume too
$custom_fields['volume'] = array(1, __('Volume'));
$custom_fields['call_number'] = array(0, __('Call Number'));
$custom_fields['availability'] = array(1, __('Availability'));
