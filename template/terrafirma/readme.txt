This template is modified for SLiMS (Senayan Library Management System)
by Hendro Wicaksono. This template is designed only for PHP-based templating system.
Do not use HTML-based templating system for this template.
