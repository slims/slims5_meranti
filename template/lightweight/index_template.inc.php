...
<a class="menu" href="index.php"><?php echo _('Home'); ?></a>&nbsp;&nbsp;
<a class="menu" href="index.php?p=libinfo"><?php echo _('Library Information'); ?></a>&nbsp;&nbsp;
<a class="menu" href="index.php?p=help"><?php echo _('Help on Search'); ?></a>&nbsp;&nbsp;
