...
if (isset($_POST['upload']) AND trim(strip_tags($_POST['fileTitle'])) != '') {
    ...
    if (isset($_FILES['file2attach']) AND $_FILES['file2attach']['size']) {
        ...
        if ($file_upload_status === UPLOAD_SUCCESS) {
            ...
            echo 'alert(\'Upload FAILED! Forbidden file type or file size too big\');';
            echo 'self.close();';
            echo '</script>';
            die();
        }
...
$form->submit_button_attr = 'name="upload" value="Upload Now" class="button"';
...
// file title
$form->addTextField('text', 'fileTitle', 'Title', $file_attach_d['file_title'], 'style="width: 100%; overflow: auto;"');
// file attachment
if ($file_attach_d['file_name']) {
    ...
    $form->addSelectList('fileDir', 'Repo. Directory', $repodir_options);
    // file upload
...
// file url
$form->addTextField('textarea', 'fileURL', 'URL', $file_attach_d['file_url'], 'rows="1" style="width: 100%; overflow: auto;"');
// file description
$form->addTextField('textarea', 'fileDesc', 'Description', $file_attach_d['file_desc'], 'rows="2" style="width: 100%; overflow: auto;"');
// file access
$acctype_options[] = array('public', 'Public');
$acctype_options[] = array('private', 'Private');
$form->addSelectList('accessType', 'Access', $acctype_options, $file_attach_d['access_type']);
