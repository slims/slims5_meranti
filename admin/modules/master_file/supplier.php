...
<div class="menuBoxInner masterFileIcon">
    <?php echo strtoupper(__('Supplier')); ?> - <a href="#" onclick="setContent('mainContent', '<?php echo MODULES_WEB_ROOT_DIR; ?>master_file/supplier.php?action=detail', 'get');" class="headerText2"><?php echo __('Add New Supplier'); ?></a>
    &nbsp; <a href="#" onclick="setContent('mainContent', '<?php echo MODULES_WEB_ROOT_DIR; ?>master_file/supplier.php', 'get');" class="headerText2"><?php echo __('Supplier List'); ?></a>
    <hr />
    ...
    <input type="button" id="doSearch" onclick="setContent('mainContent', '<?php echo MODULES_WEB_ROOT_DIR; ?>master_file/supplier.php?' + $('search').serialize(), 'post')" value="<?php echo __('Search'); ?>" class="button" />
    </form>
</div>
</fieldset>
<?php
