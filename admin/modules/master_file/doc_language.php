...
<div class="menuBoxInner masterFileIcon">
    <?php echo strtoupper(__('Doc. Language')); ?> - <a href="#" onclick="setContent('mainContent', '<?php echo MODULES_WEB_ROOT_DIR; ?>master_file/doc_language.php?action=detail', 'get');" class="headerText2"><?php echo __('Add New Language'); ?></a>
    &nbsp; <a href="#" onclick="setContent('mainContent', '<?php echo MODULES_WEB_ROOT_DIR; ?>master_file/doc_language.php', 'post');" class="headerText2"><?php echo __('Language List'); ?></a>
    <hr />
    ...
    <input type="button" id="doSearch" onclick="setContent('mainContent', '<?php echo MODULES_WEB_ROOT_DIR; ?>master_file/doc_language.php?' + $('search').serialize(), 'post')" value="<?php echo __('Search'); ?>" class="button" />
    </form>
</div>
</fieldset>
<?php
