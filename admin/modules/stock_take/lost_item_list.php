...
?>
    ...
    <legend style="font-weight: bold"><?php echo strtoupper(_('Current Lost Item')); ?> - <?php echo _('Report Filter'); ?></legend>
...
<?php
    ...
    $reportgrid->setSQLColumn('item_code AS \''._('Item Code').'\'',
        'title AS \''._('Title').'\'',
        'classification AS \''._('Classification').'\'',
        'coll_type_name AS \''._('Collection Type').'\'',
        'call_number AS \''._('Call Number').'\'');
