...
echo '<div class="infoBox">Re-synchronize will only update current stock take\'s item data. It wont update
...
echo '<input type="submit" name="resync" value="Resynchronize Now" class="button" />'."\n";
echo '</form>'."\n";
