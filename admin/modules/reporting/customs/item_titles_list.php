...
?>
    ...
    <legend style="font-weight: bold"><?php echo strtoupper(_('Items Title List')); ?> - <?php echo _('Report Filter'); ?></legend>
...
<?php
    ...
    $reportgrid->setSQLColumn('i.item_code AS \''._('Item Code').'\'',
        ...
        's.item_status_name AS \''._('Item Status').'\'',
        'b.call_number AS \''._('Call Number').'\'', 'i.biblio_id');
