...
?>
    ...
    <legend style="font-weight: bold"><?php echo strtoupper(_('Staff Activity')); ?> - <?php echo _('Report Filter'); ?></legend>
    <form method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>" target="reportView">
    <div id="filterForm">
        <div class="divRow">
            <div class="divRowLabel"><?php echo _('Activity Date From'); ?></div>
            <div class="divRowContent">
            <?php echo simbio_form_element::dateField('startDate', '2000-01-01'); ?>
            </div>
        </div>
        <div class="divRow">
            <div class="divRowLabel"><?php echo _('Activity Date Until'); ?></div>
            <div class="divRowContent">
...
<?php
    ...
    $reportgrid->setSQLColumn('u.realname AS \''._('Real Name').'\'',
        'u.username AS \''._('Login Username').'\'',
        'u.user_id AS \''._('Bibliography Data Entry').'\'',
        'u.user_id AS \''._('Item Data Entry').'\'',
        'u.user_id AS \''._('Member Data Entry').'\'',
        'u.user_id AS \''._('Circulation Tasks').'\'');
