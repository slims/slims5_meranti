...
?>
    ...
    <legend style="font-weight: bold"><?php echo strtoupper(_('Title List')); ?> - <?php echo _('Report Filter'); ?></legend>
    ...
    <div id="filterForm">
        ...
        <div class="divRow">
            <div class="divRowLabel"><?php echo _('Author'); ?></div>
            <div class="divRowContent">
        ...
        <div class="divRow">
            <div class="divRowLabel"><?php echo _('GMD'); ?></div>
            <div class="divRowContent">
            <?php
            ...
            ?> <?php echo _('Press Ctrl and click to select multiple entries'); ?>
            </div>
        </div>
        <div class="divRow">
            <div class="divRowLabel"><?php echo _('Language'); ?></div>
            <div class="divRowContent">
            <?php
            $lang_q = $dbs->query('SELECT language_id, language_name FROM mst_language');
            $lang_options = array();
            $lang_options[] = array('0', _('ALL'));
        ...
        <div class="divRow">
            <div class="divRowLabel"><?php echo _('Location'); ?></div>
            <div class="divRowContent">
            <?php
            $loc_q = $dbs->query('SELECT location_id, location_name FROM mst_location');
            $loc_options = array();
            $loc_options[] = array('0', _('ALL'));
...
<?php
    ...
    $reportgrid->setSQLColumn('b.biblio_id', 'b.title AS \''._('Title').'\'', 'COUNT(item_id) AS '._('Copies').'',
        'b.isbn_issn AS \''._('ISBN/ISSN').'\'',
        'b.call_number AS \''._('Call Number').'\'');
