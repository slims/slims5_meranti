...
class biblio_list
{
    ...
    protected function makeOutput()
    {
        ...
        while ($_biblio_d = $this->resultset->fetch_assoc()) {
            $_biblio_d['title'] = '<a href="'.$sysconf['baseurl'].'index.php?p=show_detail&id='.$_biblio_d['biblio_id'].'" title="'._('Record Detail').'">'.$_biblio_d['title'].'</a>';
            // label
            ...
            // button
            $_biblio_d['detail_button'] = '<a href="'.$sysconf['baseurl'].'index.php?p=show_detail&id='.$_biblio_d['biblio_id'].'" class="detailLink" title="'._('Record Detail').'">'._('Record Detail').'</a>';
            if ($this->xml_detail) {
            ...
            if ($_authors) {
                ...
                $_buffer .= '<div class="subItem authorField"><b>'._('Author(s)').'</b> : '.$_authors.'</div>';
            }
